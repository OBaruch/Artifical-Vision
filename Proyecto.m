...
% Last Modified by GUIDE v2.5 16-Nov-2018 00:36:44
...
setImg(imgL);%Asigna la imagen como global

imgG=getImg;%Agarra la imagen global

imshow(imgG,'Parent',handles.axes3)
...
% handles    structure with handles and user data (see GUIDATA)
img=getImg;
imgGrey=rgb2gray(img); %Imagen para manipular

    switch(get(eventdata.NewValue,'Tag'))
        case 'radiobutton1'
        ImgAlgoritmo1 = edge(imgGrey,'canny');
        imshow(ImgAlgoritmo1,'Parent',handles.axes4)%Mostrar imagen resultante en axes4
        
        
        case 'radiobutton2'    
        h=[1 3 1;3 3 3;1 3 1]/19;
        ImgAlgoritmo2 = imfilter(imgGrey,h);
        imshow(ImgAlgoritmo2,'Parent',handles.axes4)%Mostrar imagen resultante en axes4
        
        
        case 'radiobutton3'
        imgGaus = imgaussfilt(imgGrey);
        imgTemBorde=imgGrey-imgGaus;      
        ImgAlgoritmo3 = (imgTemBorde*20)+imgGrey;
        imshow(ImgAlgoritmo3,'Parent',handles.axes4)%Mostrar imagen resultante en axes4
    end       
